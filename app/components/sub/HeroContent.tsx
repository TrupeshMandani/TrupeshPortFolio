...
import { slideInFromLeft, slideInFromRight, slideInFromTop } from '@/utils/motion'; // Import animation variants
    ...
    >
      ...
      <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
        ...
        >
          <span>
            Providing
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-100'> The best </span>
            Project Experience 
          </span>
        </motion.div>
        ...
        >
          I am Trupesh Mandani, a software developer with skills in mobile app development, web development, and software development. Check out my skills and projects below.
        </motion.p>
